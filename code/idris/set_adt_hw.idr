...
|||takes one element and a list and returns all pairs of that element with elements in the list
helper2: a -> list b -> list (pair a b)
helper2 a nil = nil
helper2 a (h::t) = ((mkPair a h)::(helper2 a t))

|||takes two lists and returns a list of all pairs
helper1: list a  -> list b -> list (pair a b)
helper1 nil nil = nil
helper1 (h::t) l2 = (helper2 h l2)++(helper1 t l2)

set_product (mkSet la) (mkSet lb) = (mkSet (helper1 la lb))
...
-- cardinality of the powerset of a set of cardinality n is 2^n.
-- set_powerset: (s: set a) -> set (set a)
--powerlist: (s: list a) -> list (list a)
--powerlist nil = nil
--powerlist (h::t) =  ((h ++ (powerlist t)))


--set_powerset (mkSet a) = (mkSet (mkSet powerlist a))
set_powerset (mkSet nil) = (mkSet nil)
set_powerset (mkSet (h::nil)) = (mkSet (mkSet (h::ni)l)::(mkSet nil))
set_powerset (mkSet (h::t)) = (mkSet (mkSet h::t))++(set_powerset t)
-------------------------------------
